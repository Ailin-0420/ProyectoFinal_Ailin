 ...
 * @author Ailin
 */
public class EliminarHabitat extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Eliminar Habitat");

        jLabel2.setFont(new java.awt.Font("URW Gothic", 0, 15)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(0, 0, 0));
        jLabel2.setText("Introduce el ID del habitat a borrar:");
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
        ...
        try {
            ...
            controladores.ControladorHabitats controlador = new controladores.ControladorHabitats();
            boolean eliminado = controlador.eliminarHabitat(id);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EliminarHabitat.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EliminarHabitat().setVisible(true);
            }
        });
    }
