 ...
 * @author ailin
 */
public class VerDinoID extends javax.swing.JFrame {

    /**
     * Creates new form VerDino
     */
    public VerDinoID(int id) {
        initComponents();
        if (id > 0) {
    ...
    private void buscarYMostrarDino(int id) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VerDinoID.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
