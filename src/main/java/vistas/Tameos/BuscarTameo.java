 ...
 * @author ailin
 */
public class BuscarTameo extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Indique el ID del tameo a ver:");
    ...
    private void buscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buscarActionPerformed
        ...
        try {
            ...
            Tameos tameo = controlador.buscarTameoPorId(id);
            ...
            if (tameo != null) {
                ...
                JOptionPane.showMessageDialog(this, "No se encontró un tameo con ese ID");
            }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BuscarTameo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new BuscarTameo().setVisible(true);
            }
        });
    }
